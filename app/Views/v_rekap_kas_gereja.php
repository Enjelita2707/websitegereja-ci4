<div class="col-md-12">
    ...
    <div class="alert alert-primary alert-dismissible">
        <h5><i class="icon fas fa-info"></i>Saldo Kas Gereja</h5>
        ...
        <table class="table" id="example1">
                ...
                <tbody>
                    ...
                    <tr class="<?= $value['status'] == 'Masuk' ? 'text-success' : 'text-danger' ?>">
                        ...
                        <td><?= $value['tanggal'] ?></td>
                        <td><?= $value['ket'] ?></td>
                        <td class="text-left">Rp. <?= number_format($value['kas_masuk'], 0) ?></td>
                        <td class="text-left">Rp. <?= number_format($value['kas_keluar'], 0) ?></td>
                    </tr>
                <?php } ?>
                </tbody>
