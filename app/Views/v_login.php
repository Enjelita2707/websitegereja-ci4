...
<head>
  ...
  <title>HKBP EBENEZER | <?= $judul ?></title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-black">
    <div class="card-header text-center">
      <a href="<?= base_url() ?>" class="h1"> <i class="fas fa-church fa-3x"></i> <br> <b>HKBP EBENEZER</a>
      <h5 class="login-box-msg">Gereja HKBP EBENEZER SILAEN</h5>
